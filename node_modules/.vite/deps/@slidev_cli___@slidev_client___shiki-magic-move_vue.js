...
function createMagicMoveMachine(codeToKeyedTokens2, options = {}) {
  ...
  function commit(code, override) {
    ...
    const newTokens = codeToKeyedTokens2(code, mergedOptions.lineNumbers);
...
function toKeyedTokens(code, tokens, salt = "", lineNumbers = false) {
  ...
  const keyed = splitWhitespaceTokens(tokens).flatMap((line, lineIdx) => {
    var _a;
    firstOffset = ((_a = line[0]) == null ? void 0 : _a.offset) || lastOffset;
...
var MagicMoveRenderer = class {
  constructor(target, options = {}) {
    __publicField2(this, "mapDom", /* @__PURE__ */ new Map());
    __publicField2(this, "container");
    __publicField2(this, "anchor");
    __publicField2(this, "previousPromises", []);
    __publicField2(this, "options");
    __publicField2(this, "isFirstRender", true);
    this.options = {
      ...defaultOptions2,
      ...options
    };
  ...
  checkContainerStyleChanged(step) {
    if (!this.options.containerStyle)
      return false;
