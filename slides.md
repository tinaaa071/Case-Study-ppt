...
目前，我於「諾亞克科技」繼續以 UI/UX 設計師的角色持續精進，在這個職位中，我更專注於跨團隊協作與大型專案的執行。
...
我將帶領大家一起了解這個平台的設計思維、解決方案以及背後的設計決策。
-->
...
2. 接著，我會分享在研究與定義階段的重點發現與專案目標。

3. 之後，我將介紹我們定義的設計系統，並說明其設計邏輯與對專案整體的一致性與可擴展性的價值。

4. 最後，我們將透過一段功能演示來展示這項專案的成果。
-->
...
<!--
這項專案由「醫策會」委託，是為了外國醫療專業人員提供台灣醫療保健培訓課程的資源。

專案內容涵蓋前台與後台的設計規劃，今天我將專注於分享前台的設計部分。

我們的目標：是加強國際醫療交流與合作，並促進全球醫療知識與技能的共享。使用戶能夠輕鬆獲取所需的培訓資訊，並簡化申請及參與流程。

在這個專案中，我擔任 UI/UX 設計師，負責功能規劃與介面設計的工作。

我與跨領域的團隊密切合作，包括產品設計師、專案經理、系統分析師與開發人員，確保設計理念能夠順利落地並實現。
...
2. 接著，平台上提供的培訓資訊也十分不足，讓使用者難以完整理解整個申請流程，進而影響他們的參與意願。

3. 此外，海外醫療人員需要更具針對性和客製化的培訓計劃，幫助他們有效地達成學習目標，並能夠清晰呈現培訓成效。

4. 以及，我們遇到了文件重新提交的問題。使用者在報名過程中常常需要重複提交各種資料，這個過程既耗時又費力。

5. 最後，我們發現海外醫療人員很難獲取相關課程的回饋，這使得他們在尋找適合課程時遇到困難。
